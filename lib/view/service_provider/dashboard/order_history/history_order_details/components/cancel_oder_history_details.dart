...
class CancelOrderDetailScreenCard extends StatefulWidget {
  const CancelOrderDetailScreenCard({Key? key}) : super(key: key);

  @override
  State<CancelOrderDetailScreenCard> createState() =>
      _CancelOrderDetailScreenCardState();
}

class _CancelOrderDetailScreenCardState
    extends State<CancelOrderDetailScreenCard> {
  @override
        ...
        Container(
            ...
            decoration: BoxDecoration(
                ...
                color: Get.isDarkMode
                    ...
                    : CommonColors.whiteColor),
            child: Padding(
              padding: EdgeInsets.only(top: 20.sp, right: 20.sp, left: 20),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Container(
