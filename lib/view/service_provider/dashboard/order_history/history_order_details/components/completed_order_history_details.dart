...
class CompletedOrderDetailScreenCard extends StatefulWidget {
  const CompletedOrderDetailScreenCard({Key? key}) : super(key: key);

  @override
  State<CompletedOrderDetailScreenCard> createState() =>
      _CompletedOrderDetailScreenCardState();
}

class _CompletedOrderDetailScreenCardState
    extends State<CompletedOrderDetailScreenCard> {
  @override
        ...
        Container(
            ...
            decoration: BoxDecoration(
                ...
                color: Get.isDarkMode
                    ...
                    : CommonColors.whiteColor),
            child: Padding(
              padding: EdgeInsets.only(top: 13.sp, right: 20.sp, left: 20),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Container(
