...
class OrderHistoryCancel extends StatefulWidget {
  const OrderHistoryCancel({Key? key}) : super(key: key);

  @override
  State<OrderHistoryCancel> createState() => _OrderHistoryCancelState();
}

class _OrderHistoryCancelState extends State<OrderHistoryCancel> {
  @override
